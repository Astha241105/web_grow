  ...
  return (
    <div id="one-event-details">
      ...
      <div id="one-event-details1">
        <div id="institute">
          <img className="event-name-images-1" src="/institute2.svg" alt="college" />
          <div className="eventname-text-1">Ajay Kumar Garg Engineering College</div>
        </div>
        <div id="type-event">
          <img className="event-name-images-1" src="Offline2.svg" alt="event type" />
          <div className="eventname-text-1">Offline</div>
        </div>
        <div id="location">
          <img className="event-name-images-1" src="/updated.svg" alt="location" />
        ...
        <div id="register-for-the-event">Register</div>
    </div>
  )
}
